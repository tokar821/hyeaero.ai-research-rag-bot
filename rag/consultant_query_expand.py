...
_MODEL_REGEX: Tuple[Tuple[re.Pattern, str], ...] = tuple(
    ...
    for p, label in (
        ...
        (r"\bgulfstream\s*g\s*[-.]?\s*700\b", "Gulfstream G700"),
        (r"\bgulfstream\s*g\s*[-.]?\s*800\b", "Gulfstream G800"),
        (r"\bg\s*[-.]?\s*700\b", "Gulfstream G700"),
        (r"\bg\s*[-.]?\s*800\b", "G800"),
        ...
        (r"\b(?:cessna\s+)?longitude\b", "Citation Longitude"),
        (r"\bcitation\s+x\b", "Citation X"),
        (r"\bcitation\s+m2\b", "Citation M2"),
        (r"\bcitation\s+cj4\b", "Citation CJ4"),
        (r"\bcitation\s+cj3\b", "Citation CJ3"),
        (r"\bcitation\s+cj2\b", "Citation CJ2"),
        (r"\bcitation\s+cj1\b", "Citation CJ1"),
        (r"\bcj\s*4\b", "Citation CJ4"),
        (r"\bcj\s*3\b", "Citation CJ3"),
        (r"\bcj\s*2\b", "Citation CJ2"),
        (r"\bcj\s*1\b", "Citation CJ1"),
        ...
        # Learjet / turboprops / PC-12 (order: longer numeric first)
        (r"\blearjet\s*85\b", "Learjet 85"),
        (r"\blearjet\s*75\b", "Learjet 75"),
        (r"\blearjet\s*45\b", "Learjet 45"),
        (r"\blearjet\s*60\b", "Learjet 60"),
        (r"\blearjet\s*70\b", "Learjet 70"),
        (r"\bking\s*air\s*360\b", "King Air 360"),
        (r"\bking\s*air\s*350\b", "King Air 350"),
        (r"\bking\s*air\s*b200\b", "King Air B200"),
        (r"\b(?:cessna\s+)?(?:grand\s+)?caravan\b", "Cessna Caravan"),
        (r"\bbaron\b", "Beechcraft Baron"),
        (r"\bstationair\b", "Cessna Stationair"),
        (r"\bpc[\s-]?24\b", "PC-24"),
        (r"\bpc[\s-]?12\b", "PC-12"),
        (r"\bcitation\s+sovereign\b", "Citation Sovereign"),
        (r"\bcitation\s+excel\b", "Citation Excel"),
        (r"\bglobal\s*8000\b", "Global 8000"),
        (r"\bglobal\s*7500\b", "Global 7500"),
        (r"\bglobal\s*6500\b", "Global 6500"),
        (r"\bglobal\s*5500\b", "Global 5500"),
        (r"\bglobal\s*5000\b", "Global 5000"),
    )
)
